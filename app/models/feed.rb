class Feed < ApplicationRecord
	...
	def get_followed_account(username="tahbristol")
		client = self.initTwitterApi
		followed_account_info = client.user(username)
		new_followed_account = FollowedAccount.find_or_create_by(account_id: followed_account_info.id, account_name: username) 
