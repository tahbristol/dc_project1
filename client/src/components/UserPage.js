...
const UserPage = ({showAuthSuccess, posts, toggleUserMenu, user, userMenu, userPlatformInfo, addAccount, followedAccountsInfo, deleteFollowedAccount, markAsRead, deleteUserAccount}) => {
		return(
